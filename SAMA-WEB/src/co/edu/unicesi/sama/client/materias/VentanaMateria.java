...
public class VentanaMateria extends Window {
	...
	/**
	 * Constructor encargado de iniciar y agregar los componentes.
	 */
	...
	/**
	 * Este metodo se encarga de crear una materia.
	 */
	...
	/**
	 * Este metodo esta encargado de validar los campos.
	 * @return boolean - true si los campos son validos y viceversa.
	 */
