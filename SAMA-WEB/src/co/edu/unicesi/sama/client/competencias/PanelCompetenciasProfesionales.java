...
public class PanelCompetenciasProfesionales extends LayoutContainer {
	...
	private void actualizarLista(){
		...
		busquedaService.buscarCompetenciaPorPrograma("1", String.valueOf(programa.getIdPrograma()),new AsyncCallback<ArrayList<CompetenciaBO>> (){
			@Override
...
//			gridAsociadas.getStore().getLoader().load();
	...
	public void cargarLineasProf(){
		...
		busquedaService.buscarLineaDeCompetenciaPorCompetencia(Registry.get("idPrograma")+"", Registry.get("idCompetenciaProfesional")+"", new AsyncCallback<ArrayList<LineaCompetenciaBO>>() {
