...
public class PanelAsociarCompetenciasEspecificas extends LayoutContainer {
	...
	public PanelAsociarCompetenciasEspecificas() {
		...
		Text txtMaterias = new Text("Materias");
		add(txtMaterias);
		add(new Text());
		
		ComboBox cmbxMaterias = new ComboBox();
		cmbxMaterias.setStore(new ListStore());
		add(cmbxMaterias);
		cmbxMaterias.setSize("250px", "22");
		cmbxMaterias.setFieldLabel("Materias");
		add(new Text());
		add(new Text());
		add(new Text());
		add(new Text());
