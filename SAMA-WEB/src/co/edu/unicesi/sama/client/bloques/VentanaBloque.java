...
public class VentanaBloque extends Window {
	...
	/**
	 * TextField txtfldNombreBloque es el campo de texto para indicar el nombre del bloque
	 */
	TextField txtfldNombreBloque;
	
	/**
	 * NumberField nmbrfldCodigoBloque es el campo numerico para indicar el código del bloque
	 */
	...
	/**
	 * Constructor que se encarga de agregar los componentes e inicializarlos
	 */
	...
	/**
	 * Este método se encarga de crear el bloque a partir de los datos ingresados en los campos
	 */
	...
	/**
	 * Este método se encarga de actualizar la lista de bloques
	 */
	...
	/**
	 * Este método se encarga de asignar el programa 
	 */
