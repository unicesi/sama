...
/**
 * Esta clase esta encargada de tomar los datos para crear un nuevo programa
 */
public class VentanaPrograma extends Window {
	...
	/**
	 * TextField txtfldNombrePrograma es el campo de texto disponible para indicar el nombre del programa que se desea crear
	 */
	TextField txtfldNombrePrograma;
	
	/**
	 * NumberField nmbrfldCodigoPrograma es el campo disponible para indicar el codigo del programa que se desea crear
	 */
	TextField nmbrfldCodigoPrograma;
	
	/**
	 * TextArea txtrDescripcionPrograma es el area de texto disponible para dar la descripcion del programa que se desea crear
	 */
	...
	/**
	 * Constructor escargado de inicializar y agregar los componentes y manejar los eventos
	 */
	...
	/**
	 * Este metodo se encarga de tomar los datos ingresados por el usuario y crear un programa.
	 */
	...
	/**
	 * Este metodo esta encargado de actualizar el panel una vez se haya creado el programa
	 */
